...
class ExecutionLogger:
    ...
    def log_record(self, record):
        ...
        Parámetro `record` — dict con las siguientes claves:
            id_cliente              str
            direccion               str   — campo Dirección tal como vino del CSV
            localidad               str   — campo Localidad tal como vino del CSV
            provincia               str   — campo Provincia tal como vino del CSV
            original_address        str   — query completa enviada a la API (dir + localidad + provincia + Argentina)
            latitude                float | None
